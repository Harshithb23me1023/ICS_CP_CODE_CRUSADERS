...
Enter countdown duration in seconds: This is the number of seconds for the countdown timer.
Enter countdown duration in minutes: Additionally, you can specify a countdown duration in minutes.
Enter countdown duration in hours: If needed, you can specify a countdown duration in hours.
